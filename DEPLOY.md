...
The repo is already initialised with the first commit made. Three steps.

## 1 · Create the empty repo on GitHub

Go to https://github.com/new — name it (e.g. `rhapsody-brand-os`),
**do not** add a README, .gitignore, or licence (this repo already has files).

⚠️ **Choose Private unless you have consciously decided otherwise.**
...
firewall rationale, GC Veto Gate, data-plane segregation, capacity governance,
and an **uncleared trademark**. If the repo is on a Free/Pro/Team plan,
publishing Pages puts all of that on the open internet, indexable.

**Options, in order of preference:**

1. **GitHub Enterprise Cloud** with private Pages — reviewers sign in, nothing public.
...
3. **Public Pages with a redacted build** — strip §11 Governance and the
   Symphony Space references, and remove the "Internal / Confidential" stamp.
   Ask and I'll generate that build.
4. Public Pages with the full document — only with GC sign-off.
